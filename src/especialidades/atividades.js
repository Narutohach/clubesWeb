...
const Atividades = () => {
    ...
    const handleClickCapitulos = (livrox) => {
        ...
        // if (livrox.tipo === 10) {
        //     sessionStorage.setItem("especId", livrox.leitura);
        //     sessionStorage.setItem("origem", "edicao");
        //     sessionStorage.setItem("nomeLivro", livrox.descricao);
        //     sessionStorage.setItem("titulo", "Especialidade - " + livrox.descricao)
        ...
        //         "/ESPECIALIDADES/" + sessionStorage.getItem("categoriaId") + "/" + livrox.leitura)
        //     sessionStorage.setItem("questionPatchyz", "QUESTOES/ESPECIALIDADES/" + sessionStorage.getItem("categoriaId") + "/" + livrox.leitura)
        //
